...
const BillingEscalation = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const url = isEditing
      ? `https://screeningstar-new.onrender.com/billing-escalation/update`
      : `https://screeningstar-new.onrender.com/billing-escalation/create`;
  ...
  return (
    <>
      <div className="bg-[#c1dff2] ">
        <h2 className="text-2xl font-bold py-3 text-left text-[#4d606b] px-3 border">BILLING ESCALATION</h2>
